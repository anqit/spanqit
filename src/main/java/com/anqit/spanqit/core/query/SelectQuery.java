...
public class SelectQuery extends OuterQuery<SelectQuery> {
	 ...
	 * @return this
	 * 
	 * @see com.anqit.spanqit.core.Projection#distinct()
	 */
	 ...
	 * @return this
	 * 
	 * @see com.anqit.spanqit.core.Projection#distinct(boolean)
	 */
	 ...
	 * projection via {@link #select(Projectable...)} or {@link #select(Projection)} when printing
	 * 
	 * @return this
	 * 
	 * @see Projection#all()
